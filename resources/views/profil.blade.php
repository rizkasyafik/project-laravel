        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">PRO<span class="bg-main">FIL</span></h3>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="bio-image">
                                                  <img src="image/Rizka.jpg" alt="image" />
                                              </div>			
                                          </div>
                                      </div>	
                                  </div>
                                  <div class="col-md-6">
                                      <div class="bio-content">
                                          <h1  style="color:rgb(255, 255, 255);">BIODATA</h1>
                                <br>
                                          <h5 style="color:rgb(255, 255, 255);">Nama : Rizka Syafik</h5><h5 style="color:rgb(255, 255, 255);"> Kelas : XII RPL-2</h5 style="color:rgb(255, 255, 255);"><h5 style="color:rgb(255, 255, 255);"> Jurusan : REkayasa Perangkat Lunak</h5><h5 style="color:rgb(255, 255, 255);">Sekolah : SMKN 1 Purwosari</h5><h5 style="color:rgb(255, 255, 255);"> Tempat/Tanggal Lahir : Pasuruan/ 17 April 2003</h5>
                                <h5 style="color:rgb(255, 255, 255);">Alamat : Dsn. Gunungsari Ds. Kertosari</h5>
                              </div>
                                  </div>
                              </div>	
                          </div>
