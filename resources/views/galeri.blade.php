...
header.masthead {
    ...
    background: url('image/mlm.jpg') no-repeat center center;
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">GALE<span class="bg-main">RI</span></h3>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/1.jpg" class="fancybox" rel="ligthbox">
                ...
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/2.jpg" class="fancybox" rel="ligthbox">
                ...
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/3.jpg" class="fancybox" rel="ligthbox">
                ...
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/4.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/4.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/5.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/5.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/6.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/6.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/7.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/7.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/8.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/8.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/9.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/9.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/10.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/10.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/11.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/11.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                    <div class="music-gal item box">
                        <a href="image/12.jpg" class="fancybox" rel="ligthbox">
                        <img class="img-fluid" src="image/12.jpg">
                        </a>
                    </div>
                </div>
